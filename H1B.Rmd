...
Lets take a look at where the most H1Bs would working. 
```{r, message=FALSE, warning=FALSE, echo=FALSE}
...
```   
There are some jobs in this data set with low pay under $25000 but the median salory is 63814 USD.   
...
```   
This is not bad the trend is up more the $10000   
